import{d as n,h as a}from"./index-2lEUbfIj.js";const s=n({name:"Markdown"}),t=()=>a("div",{class:["md2vue-wrapper","markdown-body"],innerHTML:`<h2 id="组件开发">组件开发</h2><p>组件内部可通过 <strong>inject</strong> 获取 <code>isDevelopmentMode</code> 和 <code>isPreviewMode</code> 变量，分别表示是否处于开发模式和是否处于预览模式。</p>
