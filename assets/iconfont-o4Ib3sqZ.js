import{d as e,h as t}from"./index-2lEUbfIj.js";const n=e({name:"Markdown"}),s=()=>t("div",{class:["md2vue-wrapper","markdown-body"],innerHTML:`<h2 id="图标资源">图标资源</h2><blockquote>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span></span></code></pre>
  ...
  <span class="hljs-attr">&quot;props&quot;</span>: [
    ...
    </div>`});n.render=s;n.mounted=()=>{};const a=[{text:"图标资源",level:2,raw:"图标资源"},{text:"存放位置",level:3,raw:"存放位置"},{text:"资源",level:3,raw:"资源"},{text:"在项目和组件开发中使用",level:3,raw:"在项目和组件开发中使用"}],l=[{code:`src\\widget
src\\widgetIconfont
src\\widgetAssets
src\\widgetStyles
...
}`,infostring:"json"}];export{l as codeBlocks,n as default,a as headings};
