import{d as e,h as t}from"./index-2lEUbfIj.js";const n=e({name:"Markdown"}),o=()=>t("div",{class:["md2vue-wrapper","markdown-body"],innerHTML:`<h2 id="模板编辑">模板编辑</h2><p>模板文件位于 <code>/src/template</code> 下，直接在目录下新建json文件即可新增模板。</p>
<blockquote>
<h3 id="模板配置文件">模板配置文件</h3></blockquote>
  ...
  <span class="hljs-attr">&quot;template&quot;</span>: {}        <span class="hljs-comment">// 模板内容，将已经设计好的页面导出JSON，粘贴到此处即可</span>
    ...
    </div>`});n.render=o;n.mounted=()=>{};const s=[{text:"模板编辑",level:2,raw:"模板编辑"},{text:"模板配置文件",level:3,raw:"模板配置文件"}],i=[{code:`src\\widget
src\\widgetIconfont
src\\widgetAssets
src\\widgetStyles
...
}`,infostring:"json"},{code:`const props = defineProps({
